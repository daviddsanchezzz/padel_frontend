        ...
        <div className="card p-4 mb-4 border-blue-200 bg-blue-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">Explora las divisiones y ?nete a un equipo haciendo clic en "Soy [Tu Nombre]" cuando encuentres tu pareja.</p>
            </div>
          </div>
        </div>
      )}
